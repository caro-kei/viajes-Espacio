...
catalogo = Catalogo(host='juancarlosfedyna.mysql.pythonanywhere-services.com', user='juancarlosfedyna', password='nogoya2681', database='juancarlosfedyna$miapp')
...
RUTA_DESTINO = '/home/juancarlosfedyna/mysite/static/imagenes'
